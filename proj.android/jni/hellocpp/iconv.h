...
/* Allocates descriptor for code conversion from encoding �쁣romcode��to
   encoding �쁳ocode�� */
...
/* Converts, using conversion descriptor �쁟d�� at most ��inbytesleft��bytes
...
/* Frees resources allocated for conversion descriptor �쁟d�� */
#ifndef LIBICONV_PLUG
...
/* Allocates descriptor for code conversion from encoding �쁣romcode��to
   encoding �쁳ocode��into preallocated memory. Returns an error indicator
