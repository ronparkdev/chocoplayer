...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    inapp = [[MgrInApp alloc] init];
    
    [inapp isBoughtProduct:@"test"];
...
- (void)showCloudPicker{
    [CPTargetTableViewController show:viewController];
}

- (void)showMenu: (NSString*)stack{
    [CPMenuTableViewController show:viewController stack:stack];
}
